/*   STEP 1   */
export const leagueID = "1093950808565108736"; // your league ID
export const leagueName = "League of Champs Dynasty"; // your league name
...
export const managers = [
    {
      ...
      "bio": "10+ years experience managing winning fantasy football teams. Hoping to make his mark in dynasty",
      "photo": "/managers/tat.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        ...
        image: "/managers/jack.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      ...
      "philosophy": "Whatever it takes to win",
